...
# ╰──────────────────────────────────────────────────────────╯
function ff_grouptime3()
{
    CONFIG_FILE="ff_grouptime3.json"
    # Start at file 5.
    ...
    if [ -f "${TEMP_FOLDER}/temp_config_$CONFIG_FILE" ]; then CONFIG_FLAG="-C ${TEMP_FOLDER}/temp_config_$CONFIG_FILE"; fi
    ../ff_grouptime.sh ${INPUT_FILE_LIST_SKIPONE} -d 60 -o ${GROUPTIME_SKIPONE_TEMP_FILE} $CONFIG_FLAG
    unset CONFIG_FLAG
}
...
# │                   EVEN THEN ODD FILES                    │
# ╰──────────────────────────────────────────────────────────╯
function ff_grouptime4()
{
    CONFIG_FILE="ff_grouptime4.json"
    # Start at file 5.
    ...
    if [ -f "${TEMP_FOLDER}/temp_config_$CONFIG_FILE" ]; then CONFIG_FLAG="-C ${TEMP_FOLDER}/temp_config_$CONFIG_FILE"; fi
    ../ff_grouptime.sh ${INPUT_FILE_LIST_EVENODDS} -d 60 -o ${GROUPTIME_EVENODDS_TEMP_FILE} $CONFIG_FLAG
    unset CONFIG_FLAG
...
function ff_crop()
{
    ...
    if [ -f "${TEMP_FOLDER}/temp_config_$CONFIG_FILE" ]; then CONFIG_FLAG="-C ${TEMP_FOLDER}/temp_config_$CONFIG_FILE"; fi
    ../ff_crop.sh -i ${GROUPTIME_TEMP_FILE} -o ${GROUPTIME_TEMP_CROPPED_FILE} -w 480 -h 480 $CONFIG_FLAG
    ../ff_crop.sh -i ${GROUPTIME_REVERSED_TEMP_FILE} -o ${GROUPTIME_REVERSED_TEMP_CROPPED_FILE} -w 480 -h 480 $CONFIG_FLAG
    ../ff_crop.sh -i ${GROUPTIME_SKIPONE_TEMP_FILE} -o ${GROUPTIME_SKIPONE_TEMP_CROPPED_FILE} -w 480 -h 480 $CONFIG_FLAG
    ../ff_crop.sh -i ${GROUPTIME_EVENODDS_TEMP_FILE} -o ${GROUPTIME_EVENODDS_TEMP_CROPPED_FILE} -w 480 -h 480 $CONFIG_FLAG
    unset CONFIG_FLAG
}
...
function ff_stack()
{
    ...
    if [ -f "${TEMP_FOLDER}/temp_config_$CONFIG_FILE" ]; then CONFIG_FLAG="-C ${TEMP_FOLDER}/temp_config_$CONFIG_FILE"; fi
    ../ff_stack.sh -i ${GROUPTIME_TEMP_CROPPED_FILE} -i ${GROUPTIME_REVERSED_TEMP_CROPPED_FILE} -i ${GROUPTIME_SKIPONE_TEMP_CROPPED_FILE} -i ${GROUPTIME_EVENODDS_TEMP_CROPPED_FILE} -g -o ${STACK_TEMP_FILE} $CONFIG_FLAG
    unset CONFIG_FLAG
}
