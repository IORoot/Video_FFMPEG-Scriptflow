...
function main()
{
    ...
    if [ -f "$INPUT_FILENAME" ]; then
        ...
        ffmpeg -v ${LOGLEVEL} -i ${INPUT_FILENAME} ${HORIZONTAL} ${VERTICAL}  ${OUTPUT_FILENAME}
    ...
    if [ -d "$INPUT_FILENAME" ]; then
        ...
        do
            ...
            ffmpeg -v ${LOGLEVEL} -i ${INPUT_FILENAME} ${HORIZONTAL} ${VERTICAL} ${LOOP}_${OUTPUT_FILENAME}
