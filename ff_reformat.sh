...
# ╭──────────────────────────────────────────────────────────────────────────────╮
# │                                                                              │
# │                    Reformat the video for specific use-cases                 │
# │                                                                              │
# ╰──────────────────────────────────────────────────────────────────────────────╯
...
OUTPUT_FILENAME="ff_reformat.mp4"
LOGLEVEL="error"
GREP=""
...
{
    if [ "$#" -lt 2 ]; then
        printf "ℹ️ Usage:\n $0 -i <INPUT_FILE> [-f <FORMAT>] [-o <OUTPUT_FILE>] [-l loglevel]\n\n" >&2 

        printf "Summary:\n"
        printf "Reformat the video for social media.\n\n"
...
function main()
{
    ...
    printf "%-80s" "📲 ff_reformat.sh - Format for Social Media."
    ...
    if [ -d "$INPUT_FILENAME" ]; then
        ...
        do
            ...
            ffmpeg -v ${LOGLEVEL} -i ${INPUT_FILENAME} -pix_fmt yuv420p ${LOOP}_${OUTPUT_FILENAME}
