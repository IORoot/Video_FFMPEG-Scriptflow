...
// ╭──────────────────────────────────────────────────────────────────────────────╮
// │                                                                              │
// │                    Test Suite for ff_to_portrait.js                           │
// │                                                                              │
// ╰──────────────────────────────────────────────────────────────────────────────╯
...
const testConfigs = [
    ...
    },
    {
        ...
        config: {
            ff_to_portrait: {
                description: "Convert to portrait with 90 degree clockwise rotation",
                input: path.join(TEST_DIR, 'samples', 'sample_video.mp4'),
                output: "portrait_rotate1.mp4",
                rotate: "1"
            }
        }
    },
    {
        ...
        config: {
            ff_to_portrait: {
                description: "Convert to portrait with 90 degree counter-clockwise rotation",
                input: path.join(TEST_DIR, 'samples', 'sample_video.mp4'),
                output: "portrait_rotate2.mp4",
                rotate: "2"
            }
        }
    },
    {
        ...
        config: {
            ff_to_portrait: {
                description: "Convert to portrait with verbose logging",
                input: path.join(TEST_DIR, 'samples', 'sample_video.mp4'),
                output: "portrait_verbose.mp4",
                loglevel: "info"
            }
        }
    },
    {
        name: "JSON config - Basic portrait",
        config: {
            ff_to_portrait: {
                description: "Convert to portrait using JSON",
                input: path.join(TEST_DIR, 'samples', 'sample_video.mp4'),
                output: "portrait_basic_json.mp4"
            }
        }
    },
    {
        ...
        config: {
            ff_to_portrait: {
                description: "Convert to portrait with custom rotation using JSON",
                input: path.join(TEST_DIR, 'samples', 'sample_video.mp4'),
                output: "portrait_custom_json.mp4",
                rotate: "2"
            }
        }
    },
    {
        ...
        config: {
            ff_to_portrait: {
                description: "Convert to portrait with verbose logging using JSON",
                input: path.join(TEST_DIR, 'samples', 'sample_video.mp4'),
                output: "portrait_verbose_json.mp4",
                loglevel: "warning"
            }
        }
    }
...
async function runTest(testConfig) {
    ...
    try {
        // Run the ff_to_portrait.js script
        const result = await new Promise((resolve, reject) => {
            const child = spawn('node', [
                path.join(__dirname, '..', 'ff_to_portrait.js'),
                '-C', configPath
            ], {
                cwd: __dirname,
                stdio: 'pipe'
        ...
        const outputFile = path.join(__dirname, testConfig.config.ff_to_portrait.output);
...
async function runAllTests() {
    console.log("🚀 Starting ff_to_portrait.js test suite\n");
